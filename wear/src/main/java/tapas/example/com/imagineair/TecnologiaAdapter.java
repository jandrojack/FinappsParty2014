...
public class TecnologiaAdapter extends FragmentGridPagerAdapter {
    ...
    public TecnologiaAdapter(Context ctx, FragmentManager fm) {
        super(fm);
        mContext = ctx;
    }
    ...
    private final Page[][] PAGES = {
            {
                    ...
                    new Page("Oferta 2","Esto es otra oferta",R.drawable.apple),
                    new Page("Oferta 3","Y una oferta mas",R.drawable.apple),
            },
